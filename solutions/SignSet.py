...
class SignSet:
    ...
    def add(self, b: "SignSet") -> "SignSet":
        ...
        neg = (a.may_be_neg() and (b.may_be_neg() or b.may_be_zero() or b.may_be_pos())) or \
              (a.may_be_zero() and b.may_be_neg())

        pos = (a.may_be_pos() and (b.may_be_pos() or b.may_be_zero() or b.may_be_neg())) or \
              (a.may_be_zero() and b.may_be_pos())
        
        zero = (a.may_be_zero() and b.may_be_zero()) or \
    ...
    def div(self, b: "SignSet") -> tuple["SignSet", bool]:
        ...
        zero = a.may_be_zero() or neg or pos
    ...
    def rem(self, b: "SignSet") -> tuple["SignSet", bool]:
        a = self
        dz = b.may_be_zero()
        if a.is_bot() or not b.may_be_nonzero():
            return (SignSet.bot(), dz)
